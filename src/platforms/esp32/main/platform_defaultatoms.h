...
#define OPEN_DEVICE_ATOM_INDEX (SPIDRIVER_ATOMS_BASE_INDEX + 9)
#define READ_AT_ATOM_INDEX (SPIDRIVER_ATOMS_BASE_INDEX + 10)
#define WRITE_AT_ATOM_INDEX (SPIDRIVER_ATOMS_BASE_INDEX + 11)
...
#define OPEN_DEVICE_ATOM TERM_FROM_ATOM_INDEX(OPEN_DEVICE_ATOM_INDEX)
